...
export class PinchZoomComponent implements OnInit, OnChanges, OnDestroy {
  ...
  get isTouchScreen() {
    ...
    const mq = (query1: any) => {
      return window.matchMedia(query1).matches;
    };
  ...
  applyPropertiesDefault(defaultProperties1: ComponentProperties, properties: ComponentProperties): void {
    this.properties = Object.assign({}, defaultProperties1, properties);
  }
